...
const Navbar = ({ onDataFromChild, scrollToSection, refs }) => {
    ...
    return (
        <>
            <div className="h-20 w-full py-2 px-8 sm:px-12 xl:px-40 2xl:px-64 flex justify-between items-center z-10">
            ...
            <div className={`fixed text-lg lg:text-xl xl:text-2xl mdlg:hidden top-14 xs:top-20 lg:top-20 xl:top-28 2xl:top-32 right-0 h-screen bg-neutral-800 text-white font-semibold shadow-lg p-2 py-0 z-40 w-2/3 xs:w-80 transition ease-in-out delay-150 duration-300 overflow-auto ${menuVisible ? 'translate-x-0' : 'translate-x-full'}`}>
