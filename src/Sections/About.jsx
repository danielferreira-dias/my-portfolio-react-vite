...
const About = () => {
    ...
    return (
        <>
            ...
            <h1 className='mb-10 text-4xl xl:text-6xl arimo text-center' data-aos="fade-up" data-aos-duration="1000">About Me</h1>
            ...
            <div className="skill-scroll mt-10 relative overflow-hidden ">
                <div className="absolute inset-0 z-10">
                    <div className="absolute left-0 top-0 w-1/3 h-full bg-gradient-to-r from-custom-black to-transparent"></div>
                    <div className="absolute right-0 top-0 w-1/3 rotate-180 h-full bg-gradient-to-l from-transparent to-custom-black"></div>
                </div>
                <div className="skill-scroll-inner arimo-sec h-16 flex items-center relative">
                    {skills.concat(skills).map((skill, index) => (
                        <div key={index} className="skill text-2xl">
                            {skill}
                        </div>
                    ))}
                </div>
